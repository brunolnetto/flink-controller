...
from .flink_client import DeploymentConfig, FlinkClusterInfo, FlinkJobInfo
from .reconciler import JobSpec, JobState, JobStatus
...
class MetricsCollectorProtocol(Protocol):
    ...
    def record_reconciliation(
        self, job_id: str, action: str, success: bool, duration_ms: int
    ) -> None:
