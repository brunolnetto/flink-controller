...
class SavepointCreationError(SavepointError):
    ...
    def __init__(
        self, job_id: str, savepoint_dir: str, cause: Optional[Exception] = None
    ):
        super().__init__(
...
class SavepointRestoreError(SavepointError):
    ...
    def __init__(
        self, job_id: str, savepoint_path: str, cause: Optional[Exception] = None
    ):
        super().__init__(
...
class FlinkAPIError(FlinkClusterError):
    ...
    def __init__(
        ...
        super().__init__(
            message, ErrorCode.FLINK_API_ERROR, status_code=status_code, cause=cause
        )
...
class StateNotFoundError(StateStoreError):
    ...
    def __init__(self, job_id: str):
        super().__init__(
            f"Job state not found: {job_id}", ErrorCode.STATE_NOT_FOUND, job_id
        )
...
class ArtifactError(FlinkControllerError):
    ...
    def __init__(
        ...
        super().__init__(
            message, error_code, job_id, cause, context={"artifact_path": artifact_path}
        )
...
class ConfigurationError(FlinkControllerError):
    ...
    def __init__(self, message: str, config_key: Optional[str] = None):
        super().__init__(
            message, ErrorCode.CONFIGURATION_ERROR, context={"config_key": config_key}
        )
