...
from typing import Dict, List, Literal, NewType, Optional, TypedDict, Union
...
FlinkAPIResponse = Union[
    FlinkJobDetailsDict, FlinkClusterOverviewDict, CheckpointInfoDict
]
...
class StrictFlinkClient:
    ...
    def deploy_job(
        self, jar_path: ArtifactPath, config: DeploymentConfigDict
    ) -> FlinkJobId:
